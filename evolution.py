...
# Example usage
best_model = evolutionary_algorithm(population_size=10, num_generations=5,
                                    mutation_chance=0.05, mutation_volatility=0.1, num_tournaments=5, tournament_rounds=10)
